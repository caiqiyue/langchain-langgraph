...
![场景选择指南图](../assets/第一课_04_场景选择指南图.html)

**图解说明**：根据应用场景选择合适的方案 — 简单调用用SDK，需要Agent用LangChain，复杂流程用LangGraph

### 1.2 LangChain 生态概览

![LangChain生态概览图](../assets/第一课_01_LangChain生态概览图.html)
...
![LangChain底层架构图](../assets/第一课_02_LangChain底层架构图.html)
...
![Runnable接口与LCEL图](../assets/第一课_03_Runnable接口与LCEL.html)
